  ...
  return (
    ...
    >
      <div style={contentStyle}>
        ...
        {!isMobile && (
          <span>
            &nbsp;&nbsp;&copy; {currentYear} Designed and Created by Simon Rundell, Dept of Cybersecurity and Digital Technology,
        ...
        {isMobile && isHovered && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', fontSize: 'xx-small', lineHeight: '1.2' }}>
            <span>&copy; {currentYear} Simon Rundell, Dept of Cybersecurity and Digital Technology</span>
